...
Public Class Medium_VB_Pong
    ...
    Const PLAYER2X As Integer = 725 'X position of player 2
    ...
    'Sets up collision booleans for paddles
    Dim oneWithBall As Boolean = False
    Dim twoWithBall As Boolean = False
    ...
    Private Sub Form1_Paint(sender As Object, e As PaintEventArgs) Handles MyBase.Paint
        ...
        player1 = New Rectangle(PLAYER1X, player1Y, 273, 100)
        e.Graphics.FillRectangle(Brushes.White, player1)

        'Draws player2 paddle
        player2 = New Rectangle(PLAYER2X, player2Y, 27, 100)
